...
<body>
        ...
        <div class="container">
            <h1>회원관리</h1>
            <a href="../admin/managementList?type=all">전체보기&nbsp;</a>
            <a href="../admin/managementList?type=common">일반회원&nbsp;</a>
            <a href="../admin/managementList?type=excellence">우수회원&nbsp;</a>
            <a href="../admin/managementList?type=black">블랙리스트</a>
